...
fun TipTimeLayout(
    ...
    Column(
        ...
        EditNumberField(
            ...
            value = tipTimeUiState.amountInput, //TODO
            onValueChanged = { tipTimeViewModel.updateAmountInput(it) },
            modifier = Modifier.Companion.padding(bottom = 32.dp).fillMaxWidth(),
        )
        EditNumberField(
        ...
        Text(
            text = stringResource(R.string.tip_amount, tipTimeUiState.tip), //TODO
